((function() {
    ...
    register({
        vendor: [ "underscore" ]
    }, "..\\..\\node_modules\\underscore", function(global, module, exports, require, window) {
        ((function() {
            var root = this;
    ...
    register({
        ...
        module.exports = function anonymous(locals, attrs, escape, rethrow) {
            ...
            var __jade = [ {
                lineno: 1,
                filename: "C:\\Users\\Minty\\Code\\projects\\honours\\client\\scripts\\views\\templates\\home.jade"
            } ];
            try {
                var buf = [];
                with (locals || {}) {
    ...
    register({
        ...
        ((function() {
            var backbone, __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
            ...
            this.HomeView = function(_super) {
                ...
                HomeView.prototype.el = $(require("./templates/home")());
                ...
                HomeView.prototype.login = function(event) {
                    var _this = this;
                    ...
                    return setTimeout(function() {
                        _this.el.removeClass("spinning").addClass("leaving");
